...
//	cout << "trains L1-regularized logistic regression or least-squares models"
//			<< endl << endl;
//	cout << "usage: feature_file label_file regWeight output_file [options]"
//			<< endl;
//	cout
//			<< "  feature_file   input feature matrix in Matrix Market format (mxn real coordinate or array)"
//			<< endl;
//	cout << "                   rows represent features for each instance"
//			<< endl;
//	cout
...
//	cout << "  -tol <value>   sets convergence tolerance (default is 1e-4)"
//			<< endl;
//	cout << "  -m <value>     sets L-BFGS memory parameter (default is 10)"
//			<< endl;
//	cout << "  -l2weight <value>" << endl;
//	cout << "                 sets L2 regularization weight (default is 0)"
//			<< endl;
//	cout << endl;
//	exit(0);
//}
...
//				cout
//						<< "-tol (convergence tolerance) flag requires 1 positive real argument."
//						<< endl;
//				exit(1);
//			}
...
//				cout << "-l2weight flag requires 1 non-negative real argument."
//						<< endl;
//				exit(1);
//			}
...
//				cout
//						<< "-m (L-BFGS memory param) flag requires 1 positive int argument."
//						<< endl;
//				exit(1);
//			}
//		} else {
...
//	size_t size;
//	if (leastSquares) {
//		LeastSquaresProblem *prob = new LeastSquaresProblem(feature_file,
//				label_file);
//		obj = new LeastSquaresObjective(*prob, l2weight);
//		size = prob->NumFeats();
//	} else {
//		LogisticRegressionProblem *prob = new LogisticRegressionProblem(
...
//
//	if (!quiet)
//		cout << "Finished with optimization.  " << nonZero << "/" << size
//				<< " non-zero weights." << endl;
//
